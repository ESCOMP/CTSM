...
# 201 "ncdio_pio_fake.F90.in"
  end subroutine ncd_pio_openfile

  !-----------------------------------------------------------------------
# 204 "ncdio_pio_fake.F90.in"
...
# 212 "ncdio_pio_fake.F90.in"
  end subroutine ncd_pio_closefile

  !TYPE int,logical
# 215 "ncdio_pio_fake.F90.in"
...
# 299 "ncdio_pio_fake.F90.in"
  end subroutine ncd_inqdid

  !-----------------------------------------------------------------------
# 302 "ncdio_pio_fake.F90.in"
...
# 319 "ncdio_pio_fake.F90.in"
  end subroutine ncd_inqvdlen

  !-----------------------------------------------------------------------
# 322 "ncdio_pio_fake.F90.in"
...
# 386 "ncdio_pio_fake.F90.in"
  end subroutine ncd_set_var
  

  !-----------------------------------------------------------------------
# 390 "ncdio_pio_fake.F90.in"
...
# 416 "ncdio_pio_fake.F90.in"
  end subroutine ncd_reset_read_times


  !-----------------------------------------------------------------------
# 420 "ncdio_pio_fake.F90.in"
