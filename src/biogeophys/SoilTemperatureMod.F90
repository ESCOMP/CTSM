...
contains
  ...
  subroutine SoilTemperature(bounds, num_urbanl, filter_urbanl, num_nolakec, filter_nolakec, &
    ...
    associate(                                                                   & 
      ...
      call PhaseChangeH2osfc (bounds, num_nolakec, filter_nolakec, &
           ...
           waterstatebulk_inst, waterdiagnosticbulk_inst, waterflux_inst, temperature_inst,energyflux_inst)

      call Phasechange_beta (bounds, num_nolakec, filter_nolakec, &
           dhsdT(bounds%begc:bounds%endc), &
           soilstate_inst, waterstatebulk_inst, waterdiagnosticbulk_inst, waterflux_inst, energyflux_inst, temperature_inst)
  ...
  subroutine PhaseChangeH2osfc (bounds, num_nolakec, filter_nolakec, &
       dhsdT, waterstatebulk_inst, waterdiagnosticbulk_inst, waterflux_inst, temperature_inst,energyflux_inst)
    !
    ! !DESCRIPTION:
