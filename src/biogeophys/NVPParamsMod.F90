module NVPParamsMod
  ...
  real(r8) :: rnvp_amp        = 1000.0_r8  ! [PORTED by Hui Tang: raised 500->1000 to retain water (slower dry-moss evaporation)] amplitude of resistance increase when dry [s m-1]
