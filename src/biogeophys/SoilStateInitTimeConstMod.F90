...
! remove roots below bedrock layer
    ...
    do c = begc,endc
       ...
       ! Charlie Zender later on added a tuning factor (a) such that the equation becomes gwc_thr_col = a*[0.17*clay3d + 0.0014*(clay3d**2)]. (Zender et al., 2003a; https://doi.org/10.1029/2002JD002775)
