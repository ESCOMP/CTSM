...
!KO
    ...
    if (use_crop) then
!KO       call extract_accum_field ('TDM10', rbufslp, nstep) 
!KO       this%t_a10min_patch(begp:endp)= rbufslp(begp:endp)
...
!KO       call extract_accum_field ('GDD8', rbufslp, nstep) ;
!KO       this%gdd8_patch(begp:endp) = rbufslp(begp:endp)
