module HillslopeHydrologyIndependentMod
...
#include "shr_assert.h"
  ...
  type, extends(hillslope_geomorphology_type), public :: &
       hillslope_geomorphology_independent_type
     private
  ...
  end type hillslope_geomorphology_independent_type
  
  !-----------------------------------------------------------------------
  interface hillslope_geomorphology_independent_type

  end interface hillslope_geomorphology_independent_type
...
contains
  ...
  function hcol_width(this,x,alpha,beta,hill_length,hill_width,hill_height) result(width)
    ...
    !
    ! !ARGUMENTS:
    class(hillslope_geomorphology_independent_type) , intent(in) :: this
...
!    y0 = 1.0_r8 * yl
  ...
  subroutine Init(this,bounds,fsurdat)
    ...
    !
    ! !ARGUMENTS:
    class(hillslope_geomorphology_independent_type) , intent(inout) :: this
...
end module HillslopeHydrologyIndependentMod
