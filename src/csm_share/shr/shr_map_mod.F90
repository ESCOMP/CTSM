...
!EOP
  ...
  deallocate(map%xsrc,stat=irc)
  deallocate(map%ysrc,stat=irc)
  deallocate(map%xdst,stat=irc)
  deallocate(map%ydst,stat=irc)
...
!--- compress weights and copy to map ---
  ...
  deallocate(pti,stat=irc)
  deallocate(ptj,stat=irc)
  deallocate(ptw,stat=irc)
