...
! !PUBLIC MEMBER FUNCTIONS:
   ...
   public :: shr_stream_restartWrite      ! write a streams restart file
   public :: shr_stream_restartRead       ! read  a streams restart file
...
!EOP
   ...
   type shr_stream_fileType
      ...
      logical                        :: haveData = .false. ! has data been read in?
   ...
   type shr_stream_streamType
      ...
      character(SHR_KIND_CL) :: fldListFile       ! field list: file's  field names
      character(SHR_KIND_CL) :: fldListModel      ! field list: model's field names
...
! !INPUT/OUTPUT PARAMETERS:
   ...
   character(SHR_KIND_CL)         ,intent(in)  :: infoFile  ! file with stream info, must read
...
!EOP
   ...
   character(SHR_KIND_CL) :: fldNameFile  ! field list of data file fields
   character(SHR_KIND_CL) :: fldNameModel ! field list of model     fields
...
!BOP ===========================================================================
!
! !IROUTINE: shr_stream_setDebug -- Set local shr_stream debug level
!
! !DESCRIPTION:
!    Set local shr\_stream debug level, 0 = production
!    \newline
...
!BOP ===========================================================================
!
! !IROUTINE: shr_stream_getDebug -- get shr_stream internal debug level
!
! !DESCRIPTION:
!    Get shr_stream internal debug level, 0 = production
!    \newline
...
!--- restart file read/write capability ---
!--- finalize strm data type before implementing these  ---

subroutine  shr_stream_restartWrite(streams,fileName)
   type(shr_stream_streamType) :: streams(:) ! vector of data streams
   character(SHR_KIND_CL)      :: fileName   ! name of restart file
   write(6,*) "(shr_stream_restartWrite) not implemented yet"
end subroutine  shr_stream_restartWrite

subroutine  shr_stream_restartRead(streams,fileName)
   type(shr_stream_streamType) :: streams(:) ! vector of data streams
   character(SHR_KIND_CL)      :: fileName   ! name of restart file
   write(6,*) "(shr_stream_restartRead) not implemented yet"
end subroutine  shr_stream_restartRead
