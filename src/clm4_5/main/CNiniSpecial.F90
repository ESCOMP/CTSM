...
!-----------------------------------------------------------------------
   ...
   if ( use_c14 ) then
      call CNSetCcs(num_specialc, specialc, 0._r8, cc14s)
      call CNSetCcf(num_specialc, specialc, 0._r8, cc14f)
   endif
   ...
   if ( use_c14 ) then
      call CNSetPcs(num_specialp, specialp, 0._r8, pc14s)
      call CNSetPcf(num_specialp, specialp, 0._r8, pc14f)
   endif
   ...
   do fc = 1,num_specialc
      ...
      ccf%lf_conv_cflux(c) = 0._r8    ! F. Li and S. Levis
