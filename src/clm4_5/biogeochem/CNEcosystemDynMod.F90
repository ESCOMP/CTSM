...
! !PUBLIC MEMBER FUNCTIONS:
  ...
  public :: CNEcosystemDynA       ! Ecosystem dynamics: phenology, vegetation, do reaction part
  public :: CNEcosystemDynB       ! Ecosystem dynamics: phenology, vegetation, do leaching part
!
! !REVISION HISTORY:
! Created by Peter Thornton
! 19 May 2009: PET - modified to include call to harvest routine
! 12/09/2012: JYT - separated into A and B for a consistent treatment of tracer transport 
!
!
...
!BOP
!
! !IROUTINE: CNEcosystemDynA
!
! !INTERFACE:
  subroutine CNEcosystemDynA(lbc, ubc, lbp, ubp, num_soilc, filter_soilc, &
...
!-----------------------------------------------------------------------
  ...
  end subroutine CNEcosystemDynA

!-----------------------------------------------------------------------
!BOP
!
! !IROUTINE: CNEcosystemDynB
!
! !INTERFACE:
  subroutine CNEcosystemDynB(lbc, ubc, lbp, ubp, num_soilc, filter_soilc, &
                     num_soilp, filter_soilp, num_pcropp, filter_pcropp, doalb)
!
! !DESCRIPTION:
! The core CN code is executed here. Calculates fluxes for maintenance
...
! !USES:
    ...
    use CNSetValueMod        , only: CNZeroFluxes
    use CNNDynamicsMod       , only: CNNLeaching, CNSoyfix
...
!-----------------------------------------------------------------------
  ...
  end subroutine CNEcosystemDynB  
