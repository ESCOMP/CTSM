...
!-------------------------------------------------------------------------------------!
  ...
  ! ============================================================================
    ...
    leaf_frac = 1.0_r8/(1.0_r8 + EDpftcon%sapwood_ratio(ft) * currentcohort%hite + pftcon%froot_leaf(ft))     
    currentcohort%bl = currentcohort%balive*leaf_frac    
    
    if(currentcohort%status == 1.and.pftcon%evergreen(ft) /= 1)then !no leaves
       currentcohort%bl = 0.0_r8
    endif
    if(pftcon%evergreen(ft) == 1)then
       currentcohort%laimemory = 0._r8
       currentcohort%status = 2
    endif    

    currentcohort%br  = pftcon%froot_leaf(ft) * (currentcohort%balive + currentcohort%laimemory) * leaf_frac
    currentcohort%bsw = EDpftcon%sapwood_ratio(ft) * currentcohort%hite *(currentcohort%balive + &
...
!-------------------------------------------------------------------------------------!
  ...
  ! ============================================================================
    ...
    currentCohort%status      = 999           ! growth status of plant  (2 = leaves on , 1 = leaves off)
...
!-------------------------------------------------------------------------------------!
  ...
  ! ============================================================================
    ...
    currentcohort%year_net_uptake(:)   = 0._r8
...
!-------------------------------------------------------------------------------------!
  ...
  ! ============================================================================
    ...
    do while (associated(currentCohort))
       ...
       if(currentCohort%balive < 0._r8.and.currentCohort%bstore < 0._r8)then 
          terminate = 1  
          write(iulog,*) 'terminating cohorts 3', currentCohort%balive,currentCohort%bstore
       endif

       if(terminate == 1)then 
          write(iulog,*) 'terminating cohorts'  
