...
#include "shr_assert.h"
  ...
  logical                 :: irrig_ignore_data_if_missing  ! If should ignore overriding a point with soil moisture data
...
!==============================================================================
  ...
  subroutine PrescribedIrrigationInit(bounds)
    ...
    character(len=CL)  :: stream_fldfilename_irrig   ! stream filename to read
  ...
  subroutine PrescribedIrrigationAdvance( bounds )
    !
    ! Advance the prescribed irrigation stream
    !
    ! !ARGUMENTS:
