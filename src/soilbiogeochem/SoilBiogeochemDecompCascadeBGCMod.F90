    ...
    do fp = 1,num_soilp
       ...
       if (developed(g) > 0._r8) then ! == 1
          ...
          if (day < idop(p)) then
             ...
             clteff_scalar(c,:) = 1._r8
             if (patch%itype(p) >= npcropmin) then
                clteff_scalar(c,i_cel_lit) = 1.80_r8 !high 1.80,low 1.50
                clteff_scalar(c,i_lig_lit) = 1.80_r8 !high 1.80,low 1.50
                clteff_scalar(c,i_act_som) = 1.20_r8 !high 1.20,low 1.00
                clteff_scalar(c,i_slo_som) = 4.80_r8 !high 4.80,low 3.00
                clteff_scalar(c,i_pas_som) = 4.80_r8 !high 4.80,low 3.00
             end if
             ...
             if (patch%itype(p) >= npcropmin) then
                ...
                clteff_scalar(c,i_slo_som) = 3.50_r8 !high 3.50,low 1.60
                clteff_scalar(c,i_pas_som) = 3.50_r8 !high 3.50,low 1.60
             end if
             ...
             if (patch%itype(p) >= npcropmin) then
                ...
                clteff_scalar(c,i_act_som) = 1.00_r8 !high 1.00,low 1.00
                clteff_scalar(c,i_slo_som) = 2.50_r8 !high 2.50,low 1.30
                clteff_scalar(c,i_pas_som) = 2.50_r8 !high 2.50,low 1.30 
             end if
