     ...
     ! set time steps
      ...
      if ( use_vertsoilc )then
         ...
         if(num_actfirec .eq. 0)then
            ...
            call AKallsoilc%SPMP_AB(num_soilc,filter_soilc,AKsoilc,AKfiresoil,list_ready1_nofire,list_A=list_AK_AKV, list_B=list_V_AKV,&
                 NE_AB=NE_AKallsoilc,RI_AB=RI_AKallsoilc,CI_AB=CI_AKallsoilc)
            call AKallsoiln%SPMP_AB(num_soilc,filter_soilc,AKsoiln,AKfiresoil,list_ready2_nofire,list_A=list_AK_AKV, list_B=list_V_AKV,&
                 NE_AB=NE_AKallsoiln,RI_AB=RI_AKallsoiln,CI_AB=CI_AKallsoiln)
         end if
      end if
