module clm_varctl
  ...
  ! CN matrix
  !----------------------------------------------------------  
  logical, public :: use_matrixcn = .true.              ! true => use cn matrix
  logical, public :: use_soil_matrixcn = .true.  ! true => use cn matrix  
  logical, public :: isspinup = .true.              ! true => use acc spinup
  logical, public :: is_outmatrix = .false.              ! true => use acc spinup
