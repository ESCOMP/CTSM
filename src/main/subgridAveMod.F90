...
contains
  ...
  subroutine p2c_1d (bounds, parr, carr, p2c_scale_type)
    ...
    if (found) then
       ...
       call endrun(subgrid_index=index, subgrid_level=namec, msg=errMsg(sourcefile, __LINE__))
    end if
  ...
  subroutine p2g_1d(bounds, parr, garr, p2c_scale_type, c2l_scale_type, l2g_scale_type)
    ...
    if (found) then
       ...
       call endrun(subgrid_index=index, subgrid_level=nameg, msg=errMsg(sourcefile, __LINE__))
    end if
