...
type pft_cflux_type
   ...
   real(r8), pointer :: m_leafc_to_litter(:)                 ! (gC/m2/s)
   real(r8), pointer :: m_leafc_storage_to_litter(:)         ! (gC/m2/s)
   real(r8), pointer :: m_leafc_xfer_to_litter(:)            ! (gC/m2/s)
   real(r8), pointer :: m_frootc_to_litter(:)                ! (gC/m2/s)
   real(r8), pointer :: m_frootc_storage_to_litter(:)        ! (gC/m2/s)
   real(r8), pointer :: m_frootc_xfer_to_litter(:)           ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_to_litter(:)             ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_storage_to_litter(:)     ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_xfer_to_litter(:)        ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_to_litter(:)             ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_storage_to_litter(:)     ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_xfer_to_litter(:)        ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_to_litter(:)            ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_storage_to_litter(:)    ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_xfer_to_litter(:)       ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_to_litter(:)            ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_storage_to_litter(:)    ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_xfer_to_litter(:)       ! (gC/m2/s)
   real(r8), pointer :: m_gresp_storage_to_litter(:)         ! (gC/m2/s)
   real(r8), pointer :: m_gresp_xfer_to_litter(:)            ! (gC/m2/s)
   ! PFT-level fire fluxes
   real(r8), pointer :: m_leafc_to_fire(:)                   ! (gC/m2/s)
   real(r8), pointer :: m_leafc_storage_to_fire(:)           ! (gC/m2/s)
   real(r8), pointer :: m_leafc_xfer_to_fire(:)              ! (gC/m2/s)
   real(r8), pointer :: m_frootc_to_fire(:)                  ! (gC/m2/s)
   real(r8), pointer :: m_frootc_storage_to_fire(:)          ! (gC/m2/s)
   real(r8), pointer :: m_frootc_xfer_to_fire(:)             ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_to_fire(:)               ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_storage_to_fire(:)       ! (gC/m2/s)
   real(r8), pointer :: m_livestemc_xfer_to_fire(:)          ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_to_fire(:)               ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_to_litter_fire(:)        ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_storage_to_fire(:)       ! (gC/m2/s)
   real(r8), pointer :: m_deadstemc_xfer_to_fire(:)          ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_to_fire(:)              ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_storage_to_fire(:)      ! (gC/m2/s)
   real(r8), pointer :: m_livecrootc_xfer_to_fire(:)         ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_to_fire(:)              ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_to_litter_fire(:)       ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_storage_to_fire(:)      ! (gC/m2/s)
   real(r8), pointer :: m_deadcrootc_xfer_to_fire(:)         ! (gC/m2/s)
   real(r8), pointer :: m_gresp_storage_to_fire(:)           ! (gC/m2/s)
   real(r8), pointer :: m_gresp_xfer_to_fire(:)              ! (gC/m2/s)
   ! phenology fluxes from transfer pools                     
   real(r8), pointer :: leafc_xfer_to_leafc(:)               ! (gC/m2/s)
   real(r8), pointer :: frootc_xfer_to_frootc(:)             ! (gC/m2/s)
   real(r8), pointer :: livestemc_xfer_to_livestemc(:)       ! (gC/m2/s)
   real(r8), pointer :: deadstemc_xfer_to_deadstemc(:)       ! (gC/m2/s)
   real(r8), pointer :: livecrootc_xfer_to_livecrootc(:)     ! (gC/m2/s)
   real(r8), pointer :: deadcrootc_xfer_to_deadcrootc(:)     ! (gC/m2/s)
   ! leaf and fine root litterfall                           
   real(r8), pointer :: leafc_to_litter(:)                   ! (gC/m2/s)
   real(r8), pointer :: frootc_to_litter(:)                  ! (gC/m2/s)
   ! maintenance respiration fluxes                          
   real(r8), pointer :: leaf_mr(:)                           ! (gC/m2/s)
   real(r8), pointer :: froot_mr(:)                          ! (gC/m2/s)
   real(r8), pointer :: livestem_mr(:)                       ! (gC/m2/s)
   real(r8), pointer :: livecroot_mr(:)                      ! (gC/m2/s)
   real(r8), pointer :: leaf_curmr(:)                        ! (gC/m2/s)
   real(r8), pointer :: froot_curmr(:)                       ! (gC/m2/s)
   real(r8), pointer :: livestem_curmr(:)                    ! (gC/m2/s)
   real(r8), pointer :: livecroot_curmr(:)                   ! (gC/m2/s)
   real(r8), pointer :: leaf_xsmr(:)                         ! (gC/m2/s)
   real(r8), pointer :: froot_xsmr(:)                        ! (gC/m2/s)
   real(r8), pointer :: livestem_xsmr(:)                     ! (gC/m2/s)
   real(r8), pointer :: livecroot_xsmr(:)                    ! (gC/m2/s)
   ! photosynthesis fluxes                                   
   real(r8), pointer :: psnsun_to_cpool(:)                   ! (gC/m2/s)
   real(r8), pointer :: psnshade_to_cpool(:)                 ! (gC/m2/s)
   ! allocation fluxes, from current GPP                     
   real(r8), pointer :: cpool_to_xsmrpool(:)                 ! (gC/m2/s)
   real(r8), pointer :: cpool_to_leafc(:)                    ! (gC/m2/s)
   real(r8), pointer :: cpool_to_leafc_storage(:)            ! (gC/m2/s)
   real(r8), pointer :: cpool_to_frootc(:)                   ! (gC/m2/s)
   real(r8), pointer :: cpool_to_frootc_storage(:)           ! (gC/m2/s)
   real(r8), pointer :: cpool_to_livestemc(:)                ! (gC/m2/s)
   real(r8), pointer :: cpool_to_livestemc_storage(:)        ! (gC/m2/s)
   real(r8), pointer :: cpool_to_deadstemc(:)                ! (gC/m2/s)
   real(r8), pointer :: cpool_to_deadstemc_storage(:)        ! (gC/m2/s)
   real(r8), pointer :: cpool_to_livecrootc(:)               ! (gC/m2/s)
   real(r8), pointer :: cpool_to_livecrootc_storage(:)       ! (gC/m2/s)
   real(r8), pointer :: cpool_to_deadcrootc(:)               ! (gC/m2/s)
   real(r8), pointer :: cpool_to_deadcrootc_storage(:)       ! (gC/m2/s)
   real(r8), pointer :: cpool_to_gresp_storage(:)            ! (gC/m2/s)
   ! growth respiration fluxes                               
   real(r8), pointer :: cpool_leaf_gr(:)                     ! (gC/m2/s)
   real(r8), pointer :: cpool_leaf_storage_gr(:)             ! (gC/m2/s)
   real(r8), pointer :: transfer_leaf_gr(:)                  ! (gC/m2/s)
   real(r8), pointer :: cpool_froot_gr(:)                    ! (gC/m2/s)
   real(r8), pointer :: cpool_froot_storage_gr(:)            ! (gC/m2/s)
   real(r8), pointer :: transfer_froot_gr(:)                 ! (gC/m2/s)
   real(r8), pointer :: cpool_livestem_gr(:)                 ! (gC/m2/s)
   real(r8), pointer :: cpool_livestem_storage_gr(:)         ! (gC/m2/s)
   real(r8), pointer :: transfer_livestem_gr(:)              ! (gC/m2/s)
   real(r8), pointer :: cpool_deadstem_gr(:)                 ! (gC/m2/s)
   real(r8), pointer :: cpool_deadstem_storage_gr(:)         ! (gC/m2/s)
   real(r8), pointer :: transfer_deadstem_gr(:)              ! (gC/m2/s)
   real(r8), pointer :: cpool_livecroot_gr(:)                ! (gC/m2/s)
   real(r8), pointer :: cpool_livecroot_storage_gr(:)        ! (gC/m2/s)
   real(r8), pointer :: transfer_livecroot_gr(:)             ! (gC/m2/s)
   real(r8), pointer :: cpool_deadcroot_gr(:)                ! (gC/m2/s)
   real(r8), pointer :: cpool_deadcroot_storage_gr(:)        ! (gC/m2/s)
   real(r8), pointer :: transfer_deadcroot_gr(:)             ! (gC/m2/s)
   ! annual turnover of storage to transfer pools            
   real(r8), pointer :: leafc_storage_to_xfer(:)             ! (gC/m2/s)
   real(r8), pointer :: frootc_storage_to_xfer(:)            ! (gC/m2/s)
   real(r8), pointer :: livestemc_storage_to_xfer(:)         ! (gC/m2/s)
   real(r8), pointer :: deadstemc_storage_to_xfer(:)         ! (gC/m2/s)
   real(r8), pointer :: livecrootc_storage_to_xfer(:)        ! (gC/m2/s)
   real(r8), pointer :: deadcrootc_storage_to_xfer(:)        ! (gC/m2/s)
   real(r8), pointer :: gresp_storage_to_xfer(:)             ! (gC/m2/s)
