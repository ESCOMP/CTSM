...
contains
  ...
  subroutine control_init(dtime)
   ...
   namelist / clm_inparam / o3_veg_stress_method
    ...
    namelist /clm_inparm/ &
         ...
         use_nguardrail, remove_crop_residues
  ...
  subroutine control_spmd()
    ...
    call mpi_bcast (remove_crop_residues, 1, MPI_LOGICAL, 0, mpicom, ier)
  ...
  subroutine control_print ()
    ...
    write(iulog,*) '    remove_crop_residues = ', remove_crop_residues
