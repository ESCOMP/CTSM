...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%rx_sdates_thisyr(begp:endp,1:mxgrowseas)) ; this%rx_sdates_thisyr(:,:) = -1
    allocate(this%rx_cultivar_gdds_thisyr(begp:endp,1:mxgrowseas)) ; this%rx_cultivar_gdds_thisyr(:,:) = -1
