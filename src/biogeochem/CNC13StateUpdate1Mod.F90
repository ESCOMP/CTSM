...
!-----------------------------------------------------------------------
    ...
    cwdc_to_litr2c                 => clm3%g%l%c%cc13f%cwdc_to_litr2c
    cwdc_to_litr3c                 => clm3%g%l%c%cc13f%cwdc_to_litr3c
    ...
    litr1c_to_soil1c               => clm3%g%l%c%cc13f%litr1c_to_soil1c
    litr2_hr                       => clm3%g%l%c%cc13f%litr2_hr
    litr2c_to_soil2c               => clm3%g%l%c%cc13f%litr2c_to_soil2c
    litr3_hr                       => clm3%g%l%c%cc13f%litr3_hr
    litr3c_to_soil3c               => clm3%g%l%c%cc13f%litr3c_to_soil3c
    soil1_hr                       => clm3%g%l%c%cc13f%soil1_hr
    soil1c_to_soil2c               => clm3%g%l%c%cc13f%soil1c_to_soil2c
    ...
    cpool_to_xsmrpool              => clm3%g%l%c%p%pc13f%cpool_to_xsmrpool
    cpool_to_deadcrootc            => clm3%g%l%c%p%pc13f%cpool_to_deadcrootc
    cpool_to_deadcrootc_storage    => clm3%g%l%c%p%pc13f%cpool_to_deadcrootc_storage
    cpool_to_deadstemc             => clm3%g%l%c%p%pc13f%cpool_to_deadstemc
    cpool_to_deadstemc_storage     => clm3%g%l%c%p%pc13f%cpool_to_deadstemc_storage
    cpool_to_frootc                => clm3%g%l%c%p%pc13f%cpool_to_frootc
    cpool_to_frootc_storage        => clm3%g%l%c%p%pc13f%cpool_to_frootc_storage
    cpool_to_gresp_storage         => clm3%g%l%c%p%pc13f%cpool_to_gresp_storage
    cpool_to_leafc                 => clm3%g%l%c%p%pc13f%cpool_to_leafc
    cpool_to_leafc_storage         => clm3%g%l%c%p%pc13f%cpool_to_leafc_storage
    cpool_to_livecrootc            => clm3%g%l%c%p%pc13f%cpool_to_livecrootc
    cpool_to_livecrootc_storage    => clm3%g%l%c%p%pc13f%cpool_to_livecrootc_storage
    cpool_to_livestemc             => clm3%g%l%c%p%pc13f%cpool_to_livestemc
    cpool_to_livestemc_storage     => clm3%g%l%c%p%pc13f%cpool_to_livestemc_storage
    deadcrootc_storage_to_xfer     => clm3%g%l%c%p%pc13f%deadcrootc_storage_to_xfer
    deadcrootc_xfer_to_deadcrootc  => clm3%g%l%c%p%pc13f%deadcrootc_xfer_to_deadcrootc
    deadstemc_storage_to_xfer      => clm3%g%l%c%p%pc13f%deadstemc_storage_to_xfer
    ...
    livecrootc_storage_to_xfer     => clm3%g%l%c%p%pc13f%livecrootc_storage_to_xfer
    livecrootc_to_deadcrootc       => clm3%g%l%c%p%pc13f%livecrootc_to_deadcrootc
    ...
    livestemc_storage_to_xfer      => clm3%g%l%c%p%pc13f%livestemc_storage_to_xfer
    livestemc_to_deadstemc         => clm3%g%l%c%p%pc13f%livestemc_to_deadstemc
