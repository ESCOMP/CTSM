...
contains
  ...
  subroutine CNDriverNoLeaching(bounds,                                                    &
    ...
    if ( use_nguardrail .and. num_soilp>0 ) then
