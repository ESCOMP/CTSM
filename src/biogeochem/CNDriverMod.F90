...
contains
  ...
  subroutine CNDriverNoLeaching(bounds,                                                    &
    ...
    call c_products_inst%UpdateProducts(bounds, &
         ...
         reproductive_grain_to_cropprod_patch = cnveg_carbonflux_inst%reproductive_grainc_to_cropprodc_patch(begp:endp))
    ...
    if (use_c13) then
       call c13_products_inst%UpdateProducts(bounds, &
            ...
            reproductive_grain_to_cropprod_patch = c13_cnveg_carbonflux_inst%reproductive_grainc_to_cropprodc_patch(begp:endp))
    end if
    ...
    if (use_c14) then
       call c14_products_inst%UpdateProducts(bounds, &
            ...
            reproductive_grain_to_cropprod_patch = c14_cnveg_carbonflux_inst%reproductive_grainc_to_cropprodc_patch(begp:endp))
    end if
    ...
    call n_products_inst%UpdateProducts(bounds, &
         ...
         reproductive_grain_to_cropprod_patch = cnveg_nitrogenflux_inst%reproductive_grainn_to_cropprodn_patch(begp:endp))
