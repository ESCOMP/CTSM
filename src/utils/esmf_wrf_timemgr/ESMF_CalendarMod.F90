...
!
      ...
      private
        ...
        integer :: Dd = 0   ! fractional days per year denominator
...
!      public ESMF_CalendarWrite
      public ESMF_CalendarInitialized ! Only in this implimentation, intended
...
!     TMGn.n.n
      ...
      if ( calendartype%caltype  /= ESMF_CAL_NOLEAP%caltype ) then
         write(6,*) 'Not a valid calendar type for this implimentation'
         write(6,*) 'This implimentation only allows ESMF_CAL_NOLEAP'
         write(6,*) 'calender type set to     = ', calendartype%caltype
         write(6,*) 'NO_LEAP calendar type is = ', ESMF_CAL_NOLEAP%caltype
         return
      end if
      ! Don't actually do much anything, as the 360 day calendar is implicit
