module ctsm_AnnualFluxDribbler
...
#include "shr_assert.h"
  ...
  use ctsm_Decomp        , only : BOUNDS_SUBGRID_GRIDCELL, BOUNDS_SUBGRID_PATCH
  use ctsm_VarCon       , only : secspday, nameg, namep
  use ctsm_TimeManager , only : get_days_per_year, get_step_size_real, is_beg_curr_year
  use ctsm_TimeManager , only : get_curr_yearfrac, get_prev_yearfrac, get_prev_date
  use ctsm_TimeManager , only : is_first_step
  !
  implicit none
  private
...
end module ctsm_AnnualFluxDribbler
