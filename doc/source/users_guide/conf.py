...
project = u'clmdoc'
copyright = u'2018, Erik Kluzek, Bill Sacks, Ben Andre, Alice Bertini'
author = u'Erik Kluzek, Bill Sacks, Ben Andre, Alice Bertini'
...
# The format to print out today in
today_fmt = u'%Y-%m-%D %H:%M'
