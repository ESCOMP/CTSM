...
.. warning:: Because of bug 1733 (see the `models/lnd/clm/doc/KnownBugs <CLM-URL>`_ file on this) you'll need to edit the driver code in order for it to produce the correct list of fields needed to run the model later.
