...
.. _Figure BgcCrop SASU spinup plot for 1850:
...
.. _Figure BgcCrop normal mode plot for 1850:
...
Example: AD_spinup Simulation for ClmBgcCrop
--------------------------------------------------------
...
- SpinupStability_SP_v10.ncl for Sp compsets run on 2D lat/lon grids. See section :numref:`spinning-up-sp` for helpful pointers about this script that may also apply to the BgcCrop versions.
...
Example: SASU_spinup Simulation for ClmBgcCrop
------------------------------------------------------------------
::
...
Example: Normal mode simulation for ClmBgcCrop
--------------------------------------------------
::
