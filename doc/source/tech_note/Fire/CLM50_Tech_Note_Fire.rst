...
completeness factor vector (:numref:`Table PFT-specific combustion completeness and fire mortality`). Moreover, we assume that 30% and 20% of column-level litter and coarse woody debris are burned and
...
is the corresponding mortality factor vector (:numref:`Table PFT-specific combustion completeness and fire mortality`). Second,
...
(:numref:`Table PFT-specific combustion completeness and fire mortality`).
...
whole-plant mortality factor (:numref:`Table PFT-specific combustion completeness and fire mortality`).
...
factors for crop PFTs (:numref:`Table PFT-specific combustion completeness and fire mortality`).
...
.. _Table PFT-specific combustion completeness and fire mortality:
