...
# CTSM-specific: version label used at the top of some pages. (We define a new variable
# for this purpose because 'version' and 'release' are already used in the User's Guide,
# and we need a different label than either of those on master.) We need a separate
# replacement for the bolded version because it doesn't work to have variable replacements
# within formatting.
rst_epilog = """
.. |version_label| replace:: the latest development code
.. |version_label_bold| replace:: **the latest development code**
"""
