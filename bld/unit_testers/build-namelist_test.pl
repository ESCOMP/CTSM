...
my %failtest = ( 
     ...
     "toosmall soil w n_dom"     =>{ options=>"-envxml_dir .",
                                     namelst=>"toosmall_soil=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall lake w n_dom"     =>{ options=>"-envxml_dir .",
                                     namelst=>"toosmall_lake=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall crop w n_dom"     =>{ options=>"-bgc bgc -crop -envxml_dir .",
                                     namelst=>"toosmall_crop=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall wetl w n_dom"     =>{ options=>"-bgc bgc -envxml_dir .",
                                     namelst=>"toosmall_wetland=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall glc  w n_dom"     =>{ options=>"-bgc sp  -envxml_dir .",
                                     namelst=>"toosmall_glacier=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall urbtb w n_dom"    =>{ options=>"-bgc sp  -envxml_dir .",
                                     namelst=>"toosmall_urb_tbd=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall urbhd w n_dom"    =>{ options=>"-bgc sp  -envxml_dir .",
                                     namelst=>"toosmall_urb_hd=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
     "toosmall urbmd w n_dom"    =>{ options=>"-bgc sp  -envxml_dir .",
                                     namelst=>"toosmall_urb_md=10, n_dom_landunits=2",
                                     GLC_TWO_WAY_COUPLING=>"FALSE",
                                     phys=>"clm5_0",
                                   },
