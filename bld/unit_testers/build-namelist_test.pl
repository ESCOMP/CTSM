...
#
    ...
    my %env_vars = ( DIN_LOC_ROOT=>"MYDINLOCROOT", CLM_UPDATE_GLC_AREAS=>"FALSE" );
...
my %failtest = ( 
     ...
     "CNDV with fpftdyn"         =>{ options=>" -envxml_dir .",
                                     namelst=>"fpftdyn='myfpftdynfile.nc'",
                                     CLM_UPDATE_GLC_AREAS=>"FALSE",
                                     conopts=>"-bgc cndv",
                                   },
     "CNDV with fpftdyn - clm4_5"=>{ options=>"-bgc bgc -dynamic_vegetation -envxml_dir .",
                                     namelst=>"fpftdyn='myfpftdynfile.nc'",
                                     CLM_UPDATE_GLC_AREAS=>"FALSE",
                                     conopts=>"-phys clm4_5",
                                   },
...
foreach my $key ( keys(%failtest) ) {
   ...
   &make_env_run( CLM_UPDATE_GLC_AREAS=>$failtest{$key}{"CLM_UPDATE_GLC_AREAS"} );
