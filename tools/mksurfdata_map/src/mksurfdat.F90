...
! !USES:
    ...
    use mkurbanparMod      , only : mkurbanInit, mkurban, mkurbanpar, numurbl, update_max_array_urban
...
!EOP
    ...
    real(r8), allocatable  :: hasurban(:,:)      ! whether the urban class should be active in transient urban simulations
