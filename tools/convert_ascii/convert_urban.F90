...
! Determine input and output file names
  ...
  filei = '/ptmp/slevis/lsmv2_2/input/0.5x0.5/urban.dat'
  fileo = '/ptmp/slevis/lsmv2_2/input/0.5x0.5/mksrf_urban.nc'
