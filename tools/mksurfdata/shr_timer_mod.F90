!===============================================================================
! CVS: $Id: shr_timer_mod.F90,v 1.1.2.1 2005/12/22 16:25:39 tcraig Exp $
! CVS: $Source: /fs/cgd/csm/models/CVS.REPOS/tools/lnd_tools/clm2_src/mksurfdata/Attic/shr_timer_mod.F90,v $
! CVS: $Name: clm3_expa_48_brnchT_fmesh13 $
!===============================================================================
...
#if (defined UNICOSMP)
   ! This circumvents a bug in the Cray X1 system_clock function
