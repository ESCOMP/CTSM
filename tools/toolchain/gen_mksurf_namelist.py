...
class CtsmCase:
        ...
        for yr in tqdm.tqdm(range(self.start_year, self.end_year+1)):
            ...
            if (849 < yr < 1850):
                ...
                lu_input_fname = os.path.join(self.input_path, 
                            ...
                            "mksrf_landuse_SSP"+self.ssp_val+"RCP"+self.rcp_val+
                            "_clm5_"+str(yr)+".c181217.nc")
            else:
                #--This error should never happen because
                #  we have already checked years bound.
                print ("year:", yr," not valid.")
            ...
            logging.debug('year : %s', yr)
            logging.debug(lu_line)
    ...
    def build_nl (self):
        ...
        logging.debug ('dst mesh is : %s', dst_mesh)
