module gridmapMod
  ...
  interface gridmap_map
     module procedure gridmap_map_default
     module procedure gridmap_map_mask
  end interface
...
!==========================================================================
  ...
  subroutine gridmap_map_default (gridmap, src_array, dst_array)

    !--- input/output parameters ---
    type(gridmap_type) , intent(out) :: gridmap   ! gridmap data
  ...
  end subroutine gridmap_map_default

!==========================================================================

  subroutine gridmap_map_mask (gridmap, src_array, dst_array, src_mask, &
       spval)
  ...
  end subroutine gridmap_map_mask
