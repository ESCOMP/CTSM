...
snum = 1
if snum == 1:
    infile  = '/fs/cgd/csm/inputdata/lnd/clm2/surfdata_map/surfdata_0.9x1.25_78pfts_CMIP6_simyr2000_c170824.nc'
    outfile = './surfdata_0.9x1.25_78pfts_CMIP6_simyr2000_synthetic.nc'
if snum == 2:
    infile  = '/fs/cgd/csm/inputdata/lnd/clm2/surfdata_map/surfdata_10x15_78pfts_simyr2000_c170428.nc'
    outfile = './surfdata_10x15_78pfts_simyr2000_synthetic.nc'
...
if hcase == 'slope_aspect':    
    ...
    ntag = '_cosphill_'+str(phill)
    outfile = outfile.replace ('.nc',ntag+'.nc')
