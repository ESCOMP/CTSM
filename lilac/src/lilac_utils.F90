...
!========================================================================
  ...
  subroutine lilac_init_lnd2atm(lsize)
    ...
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_lat'  , units='unknown', lsize=lsize)
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_sen'  , units='unknown', lsize=lsize)
    ...
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_flxdst1', units='unknown', lsize=lsize)
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_flxdst2', units='unknown', lsize=lsize)
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_flxdst3', units='unknown', lsize=lsize)
    call lilac_lnd2atm_add_fld (lnd2atm , fldname='Fall_flxdst4', units='unknown', lsize=lsize)
